...
**Phase 3** ✅ Blueprint for button snooze - e.g. for the center button of a Home Assistant Voice PE. Superseded by Phase 6's config field and removed from the repo (no other users to keep it around for).
